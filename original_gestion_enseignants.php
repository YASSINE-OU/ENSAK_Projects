...
<div id="menu" class="menu-v">
      <ul>
        ...
        <li><a href="suivre_absence_admin.php"><img src="style/images/icons/calendar.png" id="icons">Absence</a>
        </li>
...
?>
   ...
   <br />
	...
	<ul style="list-style: none;">
        ...
        <li><button id="pta" name="liston">Liste des Enseignants</button></li><br><br><br><br>
	</ul>
	</form>
	</section>
...
mysqli_close($con);
    ...
    if (isset($_POST["delete"])) {
      ?>
      <form style="background-color: #045c7c;box-shadow: 0px 0px 2px black;text-align: center;border-radius: 7px;color: white;margin-top: 120px;margin-left: 120px;margin-right: 200px;"><br><br>
        <h1 style="color: white">Supprimer Enseignants</h1>
        <br><br><br>        
        Filière Enseigner:<select name="lise2" size="1">
        <option>GI</option>
        <option>GE</option>
        <option>GBI</option>
        </select>
...
<style type="text/css">tr,th,td {border: 2px solid black}</style>
  <h1 style="text-align: center;font-size: 35px;font-family: arial;margin-bottom: 40px;margin-top: 20px;">Liste des Enseignant</h1>
<table>
  <tr>
  <th>Nom</th>
  <th>Prenom</th>
