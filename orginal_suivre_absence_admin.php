...
<h1 style="text-align: center;color: white ;font-size: 35px;font-family: Cabin;margin-bottom: 40px;margin-top: 35px;">Suivre d'absence</h1>
<?php
...
while ($etudrow=mysqli_fetch_assoc($etudres)){
  ...
  <tr>
    ...
    <td style="width: 54%;border: 2px black solid;"><?php echo $absrow["justifiee"];?></td>
  </tr>
